    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6 text-center">
          <img class="img-fluid rounded" src="img/logo1.png" alt="Acles" style="height: 95%; width: 65%">
        </div>
        <div class="col-lg-6">
      ...
      <div class="row">
        <div class="col-lg-4 mb-4">
          <div class="card text-center">
            ...
            <div class="card-body">
              <h4 class="card-title">Fernando López</h4>
              <h6 class="card-subtitle mb-2 text-muted">Desarrollador y DBA.</h6>
              <p class="card-text">Estudiante de 2do año de la carrera de ingeniería en sistemas computacionales de la universidad envangélica de El salvador, con grandes capacidades y metas que lograr.</p>
            </div>
        ...
        <div class="col-lg-4 mb-4">
          <div class="card text-center">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Estudiante de 2do año de la carrera de ingeniería en sistemas computacionales de la universidad envangélica de El salvador, con ganas de aprender siempre y con grandes propositos.</p>
            </div>
            <div class="card-footer">
        ...
        <div class="col-lg-4 mb-4">
          <div class="card text-center">
            ...
            <div class="card-body">
              <h4 class="card-title">Cristian Gil.</h4>
              <h6 class="card-subtitle mb-2 text-muted">Desarrollador y DBA</h6>
              <p class="card-text">Estudiante de 2do año de la carrera de ingeniería en sistemas computacionales de la universidad envangélica de El salvador, con fé en lograr las metas propuestas y firme en el aprendizaje.</p>
            </div>
            <div class="card-footer">
